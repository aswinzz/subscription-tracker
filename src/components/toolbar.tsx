...
export default function Toolbar() {
    ...
    return (
        <div className="bg-white sticky bottom-0 border-t p-4 flex items-center justify-center space-x-8 backdrop-blur-lg mx-auto w-22 md:w-18 h-fit rounded-full border border-input fixed bottom-[18px] left-0 right-0">
